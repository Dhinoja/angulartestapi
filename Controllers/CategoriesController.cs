...
namespace AngularTestApi.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        {
            return _context.Categories.Include(c => c.ItemCategories).ThenInclude(ic => ic.Item);
        }
        ...
        public async Task<IActionResult> GetCategories([FromRoute] int id)
        {
            ...
            var categories = await _context.Categories.Include(c => c.ItemCategories).ThenInclude(ic => ic.Item).SingleOrDefaultAsync(m => m.CategoryId == id);
